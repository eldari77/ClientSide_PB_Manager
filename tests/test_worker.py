...
def test_execute_sos_orchestrator_runs_dashboard_child_with_existing_services(tmp_path: Path):
    ...
    install_adapter("tests.sos_dashboard_registry_mining_child", "mining ok", {"kind": "echo", "text": "mining"})
    install_adapter("tests.sos_dashboard_registry_alerts_child", "alerts ok", {"kind": "echo", "text": "alerts"})
    install_adapter("tests.sos_dashboard_registry_diagnostics_child", "diagnostics ok", {"kind": "echo", "text": "diagnostics"})
    install_adapter("tests.sos_dashboard_registry_mission_profile_child", "mission profile ok", {"kind": "echo", "text": "mission profile"})
                ...
                "ships": [
                    {
                        ...
                        "services": [
                            ...
                            {"script_id": "bridge-a-sos_mission_profile", "service_id": "mission_profile"},
    ...
    scripts = {
        ...
        "bridge-a-sos_mining": WorkerScript(
            "bridge-a-sos_mining",
            "manual",
            "Mining",
            "tests.sos_dashboard_registry_mining_child",
            "",
            "",
            1000,
            True,
        ),
        "bridge-a-sos_readiness": WorkerScript(
            "bridge-a-sos_readiness",
            "manual",
            "Readiness",
            "worker.scripts.sos_readiness",
            "",
            "",
            1000,
            True,
        ),
        "bridge-a-sos_diagnostics": WorkerScript(
            "bridge-a-sos_diagnostics",
            "manual",
            "Diagnostics",
            "tests.sos_dashboard_registry_diagnostics_child",
            "",
            "",
            1000,
            True,
        ),
        "bridge-a-sos_mission_profile": WorkerScript(
            "bridge-a-sos_mission_profile",
            "manual",
            "Mission Profile",
            "tests.sos_dashboard_registry_mission_profile_child",
            "",
            "",
            1000,
            True,
...
def test_execute_sos_orchestrator_passes_child_payload_history_to_dashboard_request(tmp_path: Path):
        ...
        json.dumps(
            {
                ...
                "result": {
                    ...
                    "child_results": [
                        ...
                        {
                            "script_id": "bridge-a-sos_mining",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "mining warning",
                            "result": {
                                "sos_mining": {
                                    "state": "warning",
                                    "snapshot_status": "ok",
                                    ...
                                    "ore_detectors": {"total_count": 1, "ready_count": 1, "range_m": 150},
                                    "collectors": {"total_count": 1, "ready_count": 1},
                                    "ejectors": {"total_count": 1, "ready_count": 1},
                                    "cargo": {"state": "pressure", "usage_ratio": 0.88},
                                    "ore": {"state": "ok", "ore_types": ["Iron"], "ore_kg": 1200},
                                    "dependencies": {
                                        "power": {"state": "ok", "hints": []},
                                        "logistics": {"state": "warning", "hints": ["cargo_pressure"]},
                                        "refinery": {"state": "warning", "hints": ["refinery_blocked:Refinery"]},
                                        "comms": {"state": "ok", "hints": []},
                                        "environment": {"state": "warning", "hints": ["storm"]},
                                        "docking": {"state": "ok", "hints": []},
                                    },
                                    "blockers": ["drill_damaged_or_offline:Port Drill"],
                                    "warnings": ["cargo_pressure"],
                                }
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "result": {
                                "sos_readiness": {
                                    "state": "degraded",
                                    "summary": "degraded score=10/14 warnings=1 blockers=0",
                                    "snapshot_status": "ok",
                                    "score": 10,
                                    "max_score": 14,
                                    "readiness_ratio": 0.714,
                                    "critical_sources": [],
                                    "warning_sources": ["power"],
                                    "unknown_sources": ["display"],
                                    "operator_action": "monitor_limited",
                                    "warnings": ["power:battery_low_charge:Main Battery"],
                                    "blockers": [],
                                }
                            },
                        },
                        {
                            "script_id": "bridge-a-sos_guidance",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "guidance warning",
                            "result": {
                                "sos_guidance": {
                                    "state": "warning",
                                    "summary": "warning priorities=1 blockers=0 warnings=1",
                                    "snapshot_status": "ok",
                                    "priorities": [
                                        {
                                            "service_id": "power",
                                            "severity": "warning",
                                            "reason": "battery_low_charge:Main Battery",
                                            "operator_hint": "inspect_power",
                                        }
                                    ],
                                    "watch_items": ["power:battery_low_charge:Main Battery"],
                                    "blockers": [],
                                    "warnings": ["power:battery_low_charge:Main Battery"],
                                    "source_services": ["readiness", "alerts"],
                                    "missing_services": ["display"],
                                }
                            },
                        },
                        {
                            "script_id": "bridge-a-sos_diagnostics",
                            "status": "ok",
                            "error_bucket": "none",
                            ...
                            "result": {
                                "sos_diagnostics": {
                                    "state": "warning",
                                    "summary": "warning missing=1 errors=1 queue=7 unexpected=1 blockers=0 warnings=3",
                                    "snapshot_status": "ok",
                                    "missing_child_results": [{"service_id": "power", "script_id": "bridge-a-sos_power"}],
                                    "child_errors": [
                                        {
                                            "service_id": "status",
                                            "script_id": "bridge-a-sos_status",
                                            "error_bucket": "script_exception",
                                        }
                                    ],
                                    "queue_pressure": {"queued": 8, "drained": 1, "remaining": 7, "state": "high"},
                                    "unexpected_command_kinds": ["status:set_block_enabled"],
                                    "warnings": ["queue_pressure_high:7"],
                                    "blockers": [],
                                }
                            },
                        },
                        {
                            "script_id": "bridge-a-sos_mission_profile",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "mission profile warning",
                            "result": {
                                "sos_mission_profile": {
                                    "state": "warning",
                                    "summary": "warning profile=Combat source=snapshot required=5/6 blockers=0 warnings=1 mismatches=1",
                                    "mode": "Docked",
                                    "profile": "Combat",
                                    "profile_source": "snapshot",
                                    "snapshot_status": "ok",
                                    "required_services": [{"service_id": "power", "state": "warning", "present": True}],
                                    "mismatches": ["mode_profile_mismatch:Docked!=Combat"],
                                    "warnings": ["mission_profile_mismatch"],
                                    "blockers": [],
                                }
                            },
                        },
                        ...
                        },
                        {
                            ...
                            "result": {
                                "sos_alerts": {
                                    ...
                                    "warning_count": 1,
                                    "blocker_count": 1,
                                    "sources": ["integrity", "systems"],
                                    "routes": [{"route": "operator", "count": 2}],
                                    "top_alerts": [
                                        {
                                            "severity": "critical",
                                            "source": "integrity",
                                            "message": "critical_block_damaged:Reactor",
                                            "routes": ["operator"],
                                        }
                                    ],
                                    "warnings": ["systems:warning:queue_pressure_remaining:2"],
                                    "blockers": ["integrity:critical:critical_block_damaged:Reactor"],
                                }
                            },
                        },
                    ],
                ...
                "ships": [
                    {
                        ...
                        "services": [
                            ...
                            {"script_id": "bridge-a-sos_guidance", "service_id": "guidance"},
                            {"script_id": "bridge-a-sos_readiness", "service_id": "readiness"},
                            {"script_id": "bridge-a-sos_diagnostics", "service_id": "diagnostics"},
                            {"script_id": "bridge-a-sos_mission_profile", "service_id": "mission_profile"},
                            {"script_id": "bridge-a-sos_alerts", "service_id": "alerts"},
    ...
    scripts = {
        ...
        "bridge-a-sos_guidance": WorkerScript("bridge-a-sos_guidance", "manual", "Guidance", module.__name__, "", "", 1000, True),
        "bridge-a-sos_readiness": WorkerScript("bridge-a-sos_readiness", "manual", "Readiness", module.__name__, "", "", 1000, True),
        "bridge-a-sos_diagnostics": WorkerScript("bridge-a-sos_diagnostics", "manual", "Diagnostics", module.__name__, "", "", 1000, True),
        "bridge-a-sos_mission_profile": WorkerScript("bridge-a-sos_mission_profile", "manual", "Mission Profile", module.__name__, "", "", 1000, True),
        "bridge-a-sos_alerts": WorkerScript("bridge-a-sos_alerts", "manual", "Alerts", module.__name__, "", "", 1000, True),
    }
    ...
    mining = telemetry["child_services_by_service_id"]["mining"]["result"]["sos_mining"]
    assert mining["state"] == "warning"
    assert mining["drills"]["active_count"] == 1
    assert mining["cargo"]["state"] == "pressure"
    assert mining["dependencies"]["environment"]["state"] == "warning"
    ...
    readiness = telemetry["child_services_by_service_id"]["readiness"]["result"]["sos_readiness"]
    assert readiness["state"] == "degraded"
    assert readiness["score"] == 10
    assert readiness["warning_sources"] == ["power"]
    guidance = telemetry["child_services_by_service_id"]["guidance"]["result"]["sos_guidance"]
    assert guidance["state"] == "warning"
    assert guidance["priorities"][0]["service_id"] == "power"
    assert guidance["source_services"] == ["readiness", "alerts"]
    diagnostics = telemetry["child_services_by_service_id"]["diagnostics"]["result"]["sos_diagnostics"]
    assert diagnostics["state"] == "warning"
    assert diagnostics["queue_pressure"]["remaining"] == 7
    assert diagnostics["unexpected_command_kinds"] == ["status:set_block_enabled"]
    mission_profile = telemetry["child_services_by_service_id"]["mission_profile"]["result"]["sos_mission_profile"]
    assert mission_profile["state"] == "warning"
    assert mission_profile["profile"] == "Combat"
    assert mission_profile["mismatches"] == ["mode_profile_mismatch:Docked!=Combat"]
    ...
    assert alerts["routes"][0]["route"] == "operator"


def test_execute_sos_orchestrator_passes_runbook_payload_history_to_dashboard_request(tmp_path: Path):
    captured: list[dict] = []
    module = types.ModuleType("tests.sos_dashboard_runbook_history_child")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_runbook",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "runbook warning",
                            "result": {
                                "sos_runbook": {
                                    "state": "warning",
                                    "snapshot_status": "ok",
                                    "procedure": "Docked Watch",
                                    "attention_items": ["production"],
                                    "warnings": ["checklist_item_attention:production"],
                                }
                            },
                        }
                    ],
                ...
                "ships": [
                    {
                        ...
                        "services": [
                            {"script_id": "bridge-a-sos_dashboard", "service_id": "dashboard"},
                            {"script_id": "bridge-a-sos_runbook", "service_id": "runbook"},
                        ],
                    }
                ],
            }
    ...
    scripts = {
        ...
        "bridge-a-sos_dashboard": WorkerScript("bridge-a-sos_dashboard", "manual", "Dashboard", module.__name__, "", "", 1000, True),
        "bridge-a-sos_runbook": WorkerScript("bridge-a-sos_runbook", "manual", "Runbook", module.__name__, "", "", 1000, True),
    }
    ...
    assert result["status"] == "ok"
    dashboard_request = captured[0]
    runbook = dashboard_request["runtime_telemetry"]["child_services_by_service_id"]["runbook"]["result"]["sos_runbook"]
    assert runbook["state"] == "warning"
    assert runbook["procedure"] == "Docked Watch"
    assert runbook["attention_items"] == ["production"]


def test_execute_sos_orchestrator_passes_watch_log_payload_history_to_dashboard_request(tmp_path: Path):
    captured: list[dict] = []
    module = types.ModuleType("tests.sos_dashboard_watch_log_history_child")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_watch_log",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "watch log warning",
                            "result": {
                                "sos_watch_log": {
                                    "state": "warning",
                                    "snapshot_status": "ok",
                                    "events": [{"source_service": "power", "severity": "warning", "message": "battery_low"}],
                                    "warnings": ["queue_pressure:2"],
                                }
                            },
                        }
                    ],
                ...
                "ships": [
                    {
                        ...
                        "services": [
                            {"script_id": "bridge-a-sos_dashboard", "service_id": "dashboard"},
                            {"script_id": "bridge-a-sos_watch_log", "service_id": "watch_log"},
                        ],
                    }
                ],
            }
    ...
    scripts = {
        ...
        "bridge-a-sos_dashboard": WorkerScript("bridge-a-sos_dashboard", "manual", "Dashboard", module.__name__, "", "", 1000, True),
        "bridge-a-sos_watch_log": WorkerScript("bridge-a-sos_watch_log", "manual", "Watch Log", module.__name__, "", "", 1000, True),
    }
    ...
    assert result["status"] == "ok"
    dashboard_request = captured[0]
    watch_log = dashboard_request["runtime_telemetry"]["child_services_by_service_id"]["watch_log"]["result"]["sos_watch_log"]
    assert watch_log["state"] == "warning"
    assert watch_log["events"][0]["source_service"] == "power"
    assert watch_log["warnings"] == ["queue_pressure:2"]
...
def test_execute_sos_dashboard_child_degrades_gracefully_without_child_history(tmp_path: Path):
    ...
    assert dashboard["readiness"]["snapshot_status"] == "missing_child_result"
    assert dashboard["guidance"]["snapshot_status"] == "missing_child_result"
    assert dashboard["capabilities"]["snapshot_status"] == "missing_child_result"
    assert dashboard["telemetry_quality"]["snapshot_status"] == "missing_child_result"
    assert dashboard["automation"]["snapshot_status"] == "missing_child_result"
    assert dashboard["automation_plan"]["snapshot_status"] == "missing_child_result"
    assert dashboard["automation_recovery"]["snapshot_status"] == "missing_child_result"
    assert dashboard["redundancy"]["snapshot_status"] == "missing_child_result"
    assert dashboard["diagnostics"]["snapshot_status"] == "missing_child_result"
    assert dashboard["config_drift"]["snapshot_status"] == "missing_child_result"
    assert dashboard["watch_log"]["snapshot_status"] == "missing_child_result"
    assert dashboard["mission_profile"]["snapshot_status"] == "missing_child_result"
...
def test_execute_sos_orchestrator_runs_alerts_child_with_existing_services(tmp_path: Path):
    ...
    install_adapter("tests.sos_alerts_registry_status_child", "status ok", {"kind": "echo", "text": "status"})
    install_adapter("tests.sos_alerts_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_alerts_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_status": WorkerScript("bridge-a-sos_status", "manual", "Status", "tests.sos_alerts_registry_status_child", "", "", 1000, True),
        "bridge-a-sos_alerts": WorkerScript(
            "bridge-a-sos_alerts",
            "manual",
            "Alerts",
        ...
        "bridge-a-inventory": WorkerScript("bridge-a-inventory", "manual", "Inventory", "tests.sos_alerts_registry_inventory_child", "", "", 1000, True),
        "bridge-a-doors": WorkerScript("bridge-a-doors", "manual", "Doors", "tests.sos_alerts_registry_door_child", "", "", 1000, True),
    }
    ...
    alerts_child = result["result"]["child_results"][1]
    assert alerts_child["summary"] == (
        "SOS Alerts Ship A state=unknown alerts=0 critical=0 warnings=0 blockers=0 snapshot=missing_child_result"
    )
    assert alerts_child["error_bucket"] == "none"
    assert alerts_child["result"]["sos_alerts"]["snapshot_status"] == "missing_child_result"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_alert_runtime_telemetry_and_queue_pressure(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_alerts_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 1,
                        "remaining": 3,
                        "by_source": {"bridge-a-sos_alerts": {"queued": 2, "drained": 0, "remaining": 2}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_status",
                            ...
                            "error_bucket": "none",
                            "summary": "status ok",
                            "result": {"sos_status": {"mode": "Combat", "warnings": ["inventory_delayed"]}},
                        },
                        {
                            "script_id": "bridge-a-sos_integrity",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "integrity critical",
                            "result": {
                                "sos_integrity": {
                                    "state": "critical",
                                    "snapshot_status": "ok",
    ...
    assert result["status"] == "ok"
    alerts_request = captured["bridge-a-sos_alerts"]
    assert alerts_request["sos_ship"]["ship_id"] == "ship-a"
    telemetry = alerts_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 4,
        "drained": 1,
    ...
    assert telemetry["child_services_by_service_id"]["status"]["result"]["sos_status"]["mode"] == "Combat"
    assert telemetry["child_services_by_service_id"]["integrity"]["result"]["sos_integrity"]["state"] == "critical"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_alerts"]["command_queue"] == {
        "queued": 2,
        "drained": 0,
        "remaining": 2,
    }
...
def test_execute_sos_orchestrator_passes_alert_snapshot_aliases_to_alerts_child_only(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_alert_alias_capture_children")
    ...
    alerts_snapshot = {"warnings": ["reactor_heat_warning"]}
    ...
    result = execute_request(
        {
            ...
            "notification_snapshot": {"alerts": ["operator_page_pending"]},
            "state": {},
        },
        scripts,
        {},
    ...
    assert result["status"] == "ok"
    assert captured["bridge-a-sos_alerts"]["alerts_snapshot"] == alerts_snapshot
    assert captured["bridge-a-sos_alerts"]["notification_snapshot"] == {"alerts": ["operator_page_pending"]}
    assert "alerts_snapshot" not in captured["bridge-a-inventory"]
    assert "notification_snapshot" not in captured["bridge-a-inventory"]


def test_execute_sos_orchestrator_runs_diagnostics_child_with_existing_services(tmp_path: Path):
    def install_adapter(module_name: str, summary: str, command: dict[str, object]) -> None:
        module = types.ModuleType(module_name)
    ...
    install_adapter("tests.sos_diagnostics_registry_status_child", "status ok", {"kind": "echo", "text": "status"})
    install_adapter("tests.sos_diagnostics_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_diagnostics_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_status": WorkerScript("bridge-a-sos_status", "manual", "Status", "tests.sos_diagnostics_registry_status_child", "", "", 1000, True),
        "bridge-a-sos_diagnostics": WorkerScript(
            "bridge-a-sos_diagnostics",
            "manual",
            "Diagnostics",
            "worker.scripts.sos_diagnostics",
            "",
            "",
            1000,
            True,
        ),
        "bridge-a-inventory": WorkerScript("bridge-a-inventory", "manual", "Inventory", "tests.sos_diagnostics_registry_inventory_child", "", "", 1000, True),
        "bridge-a-doors": WorkerScript("bridge-a-doors", "manual", "Doors", "tests.sos_diagnostics_registry_door_child", "", "", 1000, True),
    }
    ...
    diagnostics_child = result["result"]["child_results"][1]
    assert diagnostics_child["summary"] == (
        "SOS Diagnostics Ship A state=ok missing=0 errors=0 queue=0 unexpected=0 blockers=0 warnings=0"
    )
    assert diagnostics_child["error_bucket"] == "none"
    assert diagnostics_child["result"]["sos_diagnostics"]["snapshot_status"] == "ok"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_diagnostics_context_history_and_aliases_to_diagnostics_only(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_diagnostics_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 1,
                        "remaining": 7,
                        "by_source": {"bridge-a-sos_diagnostics": {"queued": 4, "drained": 1, "remaining": 3}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_status",
                            ...
                            "error_bucket": "none",
                            "summary": "status ok",
                            "result": {"sos_status": {"mode": "Combat", "warnings": []}},
                        },
                        {
                            "script_id": "bridge-a-sos_alerts",
                            "status": "ok",
                            ...
                            "result": {
                                "sos_alerts": {
                                    "state": "warning",
                                    "snapshot_status": "ok",
                                    "warnings": ["operator_route_pending"],
                                }
                            },
                        },
                    ],
    ...
    contract_snapshot = {"contract": "nominal"}
    diagnostics_snapshot = {"operator_checks": ["review_child_errors"]}
    ...
    assert result["status"] == "ok"
    diagnostics_request = captured["bridge-a-sos_diagnostics"]
    assert diagnostics_request["sos_ship"]["ship_id"] == "ship-a"
    assert diagnostics_request["contract_snapshot"] == contract_snapshot
    assert diagnostics_request["diagnostics_snapshot"] == diagnostics_snapshot
    telemetry = diagnostics_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 8,
        "drained": 1,
    ...
    assert telemetry["command_queue"] == telemetry["queue_pressure"]
    assert telemetry["child_services_by_service_id"]["status"]["result"]["sos_status"]["mode"] == "Combat"
    assert telemetry["child_services_by_service_id"]["alerts"]["result"]["sos_alerts"]["state"] == "warning"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_diagnostics"]["command_queue"] == {
        "queued": 4,
        "drained": 1,
        "remaining": 3,
    }
    for sibling in ("bridge-a-sos_status", "bridge-a-sos_alerts", "bridge-a-inventory"):
        assert "contract_snapshot" not in captured[sibling]
        assert "diagnostics_snapshot" not in captured[sibling]


def test_execute_sos_orchestrator_runs_mission_profile_child_with_existing_services(tmp_path: Path):
    def install_adapter(module_name: str, summary: str, command: dict[str, object]) -> None:
        module = types.ModuleType(module_name)
    ...
    install_adapter("tests.sos_mission_profile_registry_status_child", "status ok", {"kind": "echo", "text": "status"})
    install_adapter("tests.sos_mission_profile_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_mission_profile_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_status": WorkerScript("bridge-a-sos_status", "manual", "Status", "tests.sos_mission_profile_registry_status_child", "", "", 1000, True),
        "bridge-a-sos_mission_profile": WorkerScript(
            "bridge-a-sos_mission_profile",
            "manual",
            "Mission Profile",
            "worker.scripts.sos_mission_profile",
            "",
            "",
            1000,
            True,
        ),
        "bridge-a-inventory": WorkerScript("bridge-a-inventory", "manual", "Inventory", "tests.sos_mission_profile_registry_inventory_child", "", "", 1000, True),
        "bridge-a-doors": WorkerScript("bridge-a-doors", "manual", "Doors", "tests.sos_mission_profile_registry_door_child", "", "", 1000, True),
    }
    ...
    mission_profile_child = result["result"]["child_results"][1]
    assert mission_profile_child["summary"] == (
        "SOS Mission Profile Ship A state=unknown profile=Docked source=mode blockers=0 warnings=6"
    )
    assert mission_profile_child["error_bucket"] == "none"
    assert mission_profile_child["result"]["sos_mission_profile"]["snapshot_status"] == "missing_child_result"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_mission_profile_context_history_and_aliases_to_mission_profile_only(
    tmp_path: Path,
):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_mission_profile_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 2,
                        "remaining": 4,
                        "by_source": {"bridge-a-sos_mission_profile": {"queued": 2, "drained": 1, "remaining": 1}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_power",
                            ...
                            "error_bucket": "none",
                            "summary": "power ok",
                            "result": {"sos_power": {"state": "ok", "warnings": []}},
                        },
                        {
                            "script_id": "bridge-a-sos_logistics",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "logistics warning",
                            "result": {"sos_logistics": {"state": "warning", "warnings": ["cargo_capacity_pressure"]}},
                        },
                    ],
                },
            }
    ...
    mission_profile_snapshot = {"profile": "Combat"}
    operating_envelope_snapshot = {"minimum_service_states": {"power": "ok"}}
    ...
    result = execute_request(
        {
            ...
            "script_id": "bridge-a-orchestrator",
            "runtime_telemetry": {"limiter_state": "ok"},
            "mission_profile_snapshot": mission_profile_snapshot,
            "operating_envelope_snapshot": operating_envelope_snapshot,
            "state": {},
        },
        scripts,
        {},
    ...
    assert result["status"] == "ok"
    mission_profile_request = captured["bridge-a-sos_mission_profile"]
    assert mission_profile_request["sos_ship"]["ship_id"] == "ship-a"
    assert mission_profile_request["mission_profile_snapshot"] == mission_profile_snapshot
    assert mission_profile_request["operating_envelope_snapshot"] == operating_envelope_snapshot
    telemetry = mission_profile_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 6,
        "drained": 2,
    ...
    assert telemetry["command_queue"] == telemetry["queue_pressure"]
    assert telemetry["child_services_by_service_id"]["power"]["result"]["sos_power"]["state"] == "ok"
    assert telemetry["child_services_by_service_id"]["logistics"]["result"]["sos_logistics"]["state"] == "warning"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_mission_profile"]["command_queue"] == {
        "queued": 2,
        "drained": 1,
        "remaining": 1,
    }
    for sibling in ("bridge-a-sos_power", "bridge-a-sos_logistics", "bridge-a-inventory"):
        assert "mission_profile_snapshot" not in captured[sibling]
        assert "operating_envelope_snapshot" not in captured[sibling]


def test_execute_sos_orchestrator_runs_watch_log_child_with_existing_services(tmp_path: Path):
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_watch_log": WorkerScript(
            "bridge-a-sos_watch_log",
            "manual",
            "Watch Log",
            "worker.scripts.sos_watch_log",
            "",
            "",
            1000,
            True,
        ),
        "bridge-a-inventory": WorkerScript("bridge-a-inventory", "manual", "Inventory", "worker.scripts.sample_status_adapter", "", "", 1000, True),
        "bridge-a-doors": WorkerScript("bridge-a-doors", "manual", "Doors", "worker.scripts.sample_status_adapter", "", "", 1000, True),
    }
    ...
    watch_log_child = result["result"]["child_results"][0]
    assert watch_log_child["summary"] == "SOS Watch Log Ship A state=critical events=2 snapshot=ok"
    assert watch_log_child["result"]["sos_watch_log"]["snapshot_status"] == "ok"
    assert watch_log_child["error_bucket"] == "none"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_watch_log_context_history_and_aliases_to_watch_log_only(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_watch_log_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 3,
                        "remaining": 5,
                        "by_source": {"bridge-a-sos_watch_log": {"queued": 2, "drained": 1, "remaining": 1}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_status",
                            ...
                            "error_bucket": "none",
                            "summary": "status ok",
                            "result": {"sos_status": {"mode": "Docked", "warnings": []}},
                        },
                        {
                            "script_id": "bridge-a-sos_alerts",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "alerts warning",
                            "result": {"sos_alerts": {"state": "warning", "warnings": ["power_low"], "blockers": []}},
                        },
                    ],
                },
            }
    ...
    watch_log_snapshot = {"events": [{"source_service": "manual", "severity": "info", "message": "watch started"}]}
    event_log_snapshot = {"events": [{"source_service": "alerts", "severity": "warning", "message": "battery_low"}]}
    timeline_snapshot = {"events": [{"source_service": "status", "severity": "info", "message": "tick complete"}]}
    history_snapshot = {"events": [{"source_service": "history", "severity": "info", "message": "prior watch"}]}
    operator_log_snapshot = {"events": [{"source_service": "operator", "severity": "info", "message": "noted"}]}
    ...
    result = execute_request(
        {
            ...
            "script_id": "bridge-a-orchestrator",
            "runtime_telemetry": {"limiter_state": "ok"},
            "watch_log_snapshot": watch_log_snapshot,
            "event_log_snapshot": event_log_snapshot,
            "timeline_snapshot": timeline_snapshot,
            "history_snapshot": history_snapshot,
            "operator_log_snapshot": operator_log_snapshot,
            "state": {},
        },
        scripts,
        {},
    ...
    assert result["status"] == "ok"
    watch_log_request = captured["bridge-a-sos_watch_log"]
    assert watch_log_request["sos_ship"]["ship_id"] == "ship-a"
    assert watch_log_request["watch_log_snapshot"] == watch_log_snapshot
    assert watch_log_request["event_log_snapshot"] == event_log_snapshot
    assert watch_log_request["timeline_snapshot"] == timeline_snapshot
    assert watch_log_request["history_snapshot"] == history_snapshot
    assert watch_log_request["operator_log_snapshot"] == operator_log_snapshot
    telemetry = watch_log_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 8,
        "drained": 3,
    ...
    assert telemetry["command_queue"] == telemetry["queue_pressure"]
    assert telemetry["child_services_by_service_id"]["status"]["result"]["sos_status"]["mode"] == "Docked"
    assert telemetry["child_services_by_service_id"]["alerts"]["result"]["sos_alerts"]["state"] == "warning"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_watch_log"]["command_queue"] == {
        "queued": 2,
        "drained": 1,
        "remaining": 1,
    }
    for sibling in ("bridge-a-sos_status", "bridge-a-sos_alerts", "bridge-a-inventory"):
        assert "watch_log_snapshot" not in captured[sibling]
        assert "event_log_snapshot" not in captured[sibling]
        assert "timeline_snapshot" not in captured[sibling]
        assert "history_snapshot" not in captured[sibling]
        assert "operator_log_snapshot" not in captured[sibling]


def test_execute_sos_orchestrator_passes_endurance_payload_history_to_dashboard_request(tmp_path: Path):
    captured: list[dict] = []
    module = types.ModuleType("tests.sos_dashboard_endurance_history_child")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_endurance",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "endurance warning",
                            "result": {
                                "sos_endurance": {
                                    "state": "warning",
                                    "snapshot_status": "ok",
                                    "summary": "warning cargo=ok fuel=warning",
                                    "warnings": ["fuel_runway_low"],
                                }
                            },
                        }
                    ],
                ...
                "ships": [
                    {
                        ...
                        "services": [
                            {"script_id": "bridge-a-sos_dashboard", "service_id": "dashboard"},
                            {"script_id": "bridge-a-sos_endurance", "service_id": "endurance"},
                        ],
                    }
                ],
            }
    ...
    scripts = {
        ...
        "bridge-a-sos_dashboard": WorkerScript("bridge-a-sos_dashboard", "manual", "Dashboard", module.__name__, "", "", 1000, True),
        "bridge-a-sos_endurance": WorkerScript("bridge-a-sos_endurance", "manual", "Endurance", module.__name__, "", "", 1000, True),
    }
    ...
    assert result["status"] == "ok"
    dashboard_request = captured[0]
    endurance = dashboard_request["runtime_telemetry"]["child_services_by_service_id"]["endurance"]["result"]["sos_endurance"]
    assert endurance["state"] == "warning"
    assert endurance["snapshot_status"] == "ok"
    assert endurance["warnings"] == ["fuel_runway_low"]


def test_execute_sos_orchestrator_runs_endurance_child_with_existing_services(tmp_path: Path):
    def install_adapter(module_name: str, summary: str, command: dict[str, object]) -> None:
        module = types.ModuleType(module_name)
    ...
    install_adapter("tests.sos_endurance_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_endurance_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_endurance": WorkerScript(
            "bridge-a-sos_endurance",
            "manual",
            "Endurance",
            "worker.scripts.sos_endurance",
            "",
            "",
            1000,
            True,
        ...
        "bridge-a-inventory": WorkerScript(
            "bridge-a-inventory", "manual", "Inventory", "tests.sos_endurance_registry_inventory_child", "", "", 1000, True
        ),
        "bridge-a-doors": WorkerScript("bridge-a-doors", "manual", "Doors", "tests.sos_endurance_registry_door_child", "", "", 1000, True),
    }
    ...
    endurance_child = result["result"]["child_results"][0]
    assert endurance_child["summary"] == (
        "SOS Endurance Ship A state=unknown cargo=unknown ammo=unknown fuel=unknown energy=unknown "
        "survival=unknown transit=unknown sources=0 warnings=1"
    )
    assert endurance_child["result"]["sos_endurance"]["snapshot_status"] == "missing_child_result"
    assert endurance_child["error_bucket"] == "none"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_endurance_context_history_and_aliases_to_endurance_only(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_endurance_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 4,
                        "remaining": 5,
                        "by_source": {"bridge-a-sos_endurance": {"queued": 3, "drained": 1, "remaining": 2}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_power",
                            ...
                            "error_bucket": "none",
                            "summary": "power warning",
                            "result": {"sos_power": {"state": "warning", "warnings": ["battery_low"], "blockers": []}},
                        },
                        {
                            "script_id": "bridge-a-sos_life_support",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "life ok",
                            "result": {"sos_life_support": {"state": "ok", "warnings": [], "blockers": []}},
                        },
                        {
                            "script_id": "bridge-a-sos_mining",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "mining ok",
                            "result": {"sos_mining": {"state": "ok", "warnings": [], "blockers": []}},
                        },
                    ],
                },
            }
    ...
    consumables_snapshot = {"fuel": {"hydrogen": {"current": 12, "minimum": 20}}}
    resource_forecast_snapshot = {"energy": {"runway_seconds": 3600}}
    supply_snapshot = {"ammo": {"NATO_25x184mm": {"current": 10, "minimum": 20}}}
    runway_snapshot = {"survival": {"oxygen_runway_seconds": 7200}}
    mining_snapshot = {"state": "ok", "ores": [{"name": "Iron", "current": 1000}]}
    ...
    result = execute_request(
        {
            ...
            "grid_snapshot": {
                ...
                "grid_entity_id": 10,
                "blocks": [
                    {"name": "Battery", "type": "BatteryBlock", "integrity_ratio": 0.9, "functional": True},
                ],
            },
            "inventory_snapshot": {
                "blocks": [
                        ...
                        "inventories": [
                            {
                                "current_volume": 12,
                                "max_volume": 100,
                                "items": [{"type_id": "MyObjectBuilder_Ore", "subtype_id": "Ice", "amount": 5}],
                            }
                        ],
                    },
                ],
            },
            "endurance_snapshot": endurance_snapshot,
            "consumables_snapshot": consumables_snapshot,
            "resource_forecast_snapshot": resource_forecast_snapshot,
            "supply_snapshot": supply_snapshot,
            "runway_snapshot": runway_snapshot,
            "power_snapshot": {"state": "warning"},
            "life_support_snapshot": {"state": "ok"},
            "transit_snapshot": {"state": "ok"},
            "production_snapshot": {"state": "ok"},
    ...
    assert result["status"] == "ok"
    endurance_request = captured["bridge-a-sos_endurance"]
    assert endurance_request["sos_ship"]["ship_id"] == "ship-a"
    assert endurance_request["endurance_snapshot"] == endurance_snapshot
    assert endurance_request["consumables_snapshot"] == consumables_snapshot
    assert endurance_request["resource_forecast_snapshot"] == resource_forecast_snapshot
    assert endurance_request["supply_snapshot"] == supply_snapshot
    assert endurance_request["runway_snapshot"] == runway_snapshot
    assert endurance_request["grid_snapshot"]["grid_entity_id"] == 10
    assert endurance_request["integrity_snapshot"]["blocks"][0]["name"] == "Battery"
    assert endurance_request["inventory_snapshot"]["cargo"] == {"used_volume": 12.0, "max_volume": 100.0}
    assert endurance_request["power_snapshot"] == {"state": "warning"}
    assert endurance_request["life_support_snapshot"] == {"state": "ok"}
    assert endurance_request["transit_snapshot"] == {"state": "ok"}
    assert endurance_request["production_snapshot"] == {"state": "ok"}
    assert endurance_request["mining_snapshot"] == mining_snapshot
    telemetry = endurance_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 9,
        "drained": 4,
    ...
    assert telemetry["command_queue"] == telemetry["queue_pressure"]
    assert telemetry["child_services_by_service_id"]["power"]["result"]["sos_power"]["state"] == "warning"
    assert telemetry["child_services_by_service_id"]["life_support"]["result"]["sos_life_support"]["state"] == "ok"
    assert telemetry["child_services_by_service_id"]["mining"]["result"]["sos_mining"]["state"] == "ok"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_endurance"]["command_queue"] == {
        "queued": 3,
        "drained": 1,
        "remaining": 2,
    }
    for sibling in ("bridge-a-sos_status", "bridge-a-sos_power", "bridge-a-sos_life_support", "bridge-a-sos_mining", "bridge-a-inventory"):
        assert "endurance_snapshot" not in captured[sibling]
        assert "consumables_snapshot" not in captured[sibling]
        assert "resource_forecast_snapshot" not in captured[sibling]
        assert "supply_snapshot" not in captured[sibling]
        assert "runway_snapshot" not in captured[sibling]


def test_execute_sos_orchestrator_passes_redundancy_payload_history_to_dashboard_request(tmp_path: Path):
    captured: list[dict] = []
    module = types.ModuleType("tests.sos_dashboard_redundancy_history_child")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_redundancy",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "redundancy warning",
                            "result": {
                                "sos_redundancy": {
                                    "state": "warning",
                                    "snapshot_status": "ok",
                                    "summary": "warning covered=7/9",
                                    "warnings": ["backup_unavailable:power_generation_storage"],
                                }
                            },
                        }
                    ],
                ...
                "ships": [
                    {
                        ...
                        "services": [
                            {"script_id": "bridge-a-sos_dashboard", "service_id": "dashboard"},
                            {"script_id": "bridge-a-sos_redundancy", "service_id": "redundancy"},
                        ],
                    }
                ],
            }
    ...
    scripts = {
        ...
        "bridge-a-sos_dashboard": WorkerScript("bridge-a-sos_dashboard", "manual", "Dashboard", module.__name__, "", "", 1000, True),
        "bridge-a-sos_redundancy": WorkerScript("bridge-a-sos_redundancy", "manual", "Redundancy", module.__name__, "", "", 1000, True),
    }
    ...
    assert result["status"] == "ok"
    dashboard_request = captured[0]
    redundancy = dashboard_request["runtime_telemetry"]["child_services_by_service_id"]["redundancy"]["result"]["sos_redundancy"]
    assert redundancy["state"] == "warning"
    assert redundancy["snapshot_status"] == "ok"
    assert redundancy["warnings"] == ["backup_unavailable:power_generation_storage"]


def test_execute_sos_orchestrator_passes_capabilities_payload_history_to_dashboard_request(tmp_path: Path):
    captured: list[dict] = []
    module = types.ModuleType("tests.sos_dashboard_capabilities_history_child")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_capabilities",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "capabilities warning",
                            "result": {
                                "sos_capabilities": {
                                    "state": "warning",
                                    "snapshot_status": "ok",
                                    "summary": "warning role=miner observed=general",
                                    "warnings": ["role_mismatch:miner:general"],
                                }
                            },
                        }
                    ],
                ...
                "ships": [
                    {
                        ...
                        "services": [
                            {"script_id": "bridge-a-sos_dashboard", "service_id": "dashboard"},
                            {"script_id": "bridge-a-sos_capabilities", "service_id": "capabilities"},
                        ],
                    }
                ],
            }
    ...
    scripts = {
        ...
        "bridge-a-sos_dashboard": WorkerScript("bridge-a-sos_dashboard", "manual", "Dashboard", module.__name__, "", "", 1000, True),
        "bridge-a-sos_capabilities": WorkerScript("bridge-a-sos_capabilities", "manual", "Capabilities", module.__name__, "", "", 1000, True),
    }
    ...
    assert result["status"] == "ok"
    dashboard_request = captured[0]
    capabilities = dashboard_request["runtime_telemetry"]["child_services_by_service_id"]["capabilities"]["result"]["sos_capabilities"]
    assert capabilities["state"] == "warning"
    assert capabilities["snapshot_status"] == "ok"
    assert capabilities["warnings"] == ["role_mismatch:miner:general"]


def test_execute_sos_orchestrator_runs_capabilities_child_with_existing_services(tmp_path: Path):
    def install_adapter(module_name: str, summary: str, command: dict[str, object]) -> None:
        module = types.ModuleType(module_name)
    ...
    install_adapter("tests.sos_capabilities_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_capabilities_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_capabilities": WorkerScript(
            "bridge-a-sos_capabilities",
            "manual",
            "Capabilities",
            "worker.scripts.sos_capabilities",
            "",
            "",
            1000,
            True,
        ...
        "bridge-a-inventory": WorkerScript(
            "bridge-a-inventory", "manual", "Inventory", "tests.sos_capabilities_registry_inventory_child", "", "", 1000, True
        ),
        "bridge-a-doors": WorkerScript("bridge-a-doors", "manual", "Doors", "tests.sos_capabilities_registry_door_child", "", "", 1000, True),
    }
    ...
    capabilities_child = result["result"]["child_results"][0]
    assert capabilities_child["summary"] == "SOS Capabilities Ship A state=unknown snapshot=missing_child_result"
    assert capabilities_child["result"]["sos_capabilities"]["snapshot_status"] == "missing_child_result"
    assert capabilities_child["error_bucket"] == "none"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_capabilities_context_history_and_aliases_to_capabilities_only(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_capabilities_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 4,
                        "remaining": 5,
                        "by_source": {"bridge-a-sos_capabilities": {"queued": 3, "drained": 1, "remaining": 2}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_status",
                            ...
                            "error_bucket": "none",
                            "summary": "status ok",
                            "result": {"sos_status": {"mode": "Docked", "identity_status": "ok"}},
                        },
                        {
                            "script_id": "bridge-a-sos_integrity",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "integrity warning",
                            "result": {"sos_integrity": {"state": "warning", "warnings": ["damaged_block:Thruster"], "blockers": []}},
                        },
                    ],
                },
            }
    ...
    capability_snapshot = {"capabilities": {"mining": {"state": "present", "evidence": ["drill"]}}}
    capabilities_snapshot = {"capabilities": {"power": {"state": "present", "evidence": ["battery"]}}}
    ship_capabilities_snapshot = {"capabilities": {"display": {"state": "present", "evidence": ["lcd"]}}}
    role_snapshot = {"declared_role": "miner", "observed_role": "utility"}
    ...
    result = execute_request(
        {
            ...
            "grid_snapshot": {
                ...
                "grid_entity_id": 10,
                "blocks": [
                    {"name": "Thruster", "type": "Thrust", "integrity_ratio": 0.8, "functional": True},
                ],
            },
            "capability_snapshot": capability_snapshot,
            "capabilities_snapshot": capabilities_snapshot,
            "ship_capabilities_snapshot": ship_capabilities_snapshot,
    ...
    assert result["status"] == "ok"
    capabilities_request = captured["bridge-a-sos_capabilities"]
    assert capabilities_request["sos_ship"]["ship_id"] == "ship-a"
    assert capabilities_request["capability_snapshot"] == capability_snapshot
    assert capabilities_request["capabilities_snapshot"] == capabilities_snapshot
    assert capabilities_request["ship_capabilities_snapshot"] == ship_capabilities_snapshot
    assert capabilities_request["role_snapshot"] == role_snapshot
    assert capabilities_request["grid_snapshot"]["grid_entity_id"] == 10
    assert capabilities_request["integrity_snapshot"]["blocks"][0]["name"] == "Thruster"
    telemetry = capabilities_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 9,
        "drained": 4,
    ...
    assert telemetry["command_queue"] == telemetry["queue_pressure"]
    assert telemetry["child_services_by_service_id"]["status"]["result"]["sos_status"]["identity_status"] == "ok"
    assert telemetry["child_services_by_service_id"]["integrity"]["result"]["sos_integrity"]["state"] == "warning"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_capabilities"]["command_queue"] == {
        "queued": 3,
        "drained": 1,
        "remaining": 2,
    }
    for sibling in ("bridge-a-sos_status", "bridge-a-sos_integrity"):
        assert "capability_snapshot" not in captured[sibling]
        assert "capabilities_snapshot" not in captured[sibling]
        assert "ship_capabilities_snapshot" not in captured[sibling]
        assert "role_snapshot" not in captured[sibling]


def test_execute_sos_orchestrator_passes_topology_payload_history_to_dashboard_request(tmp_path: Path):
    captured: list[dict] = []
    module = types.ModuleType("tests.sos_dashboard_topology_history_child")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_topology",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "topology warning",
                            "result": {
                                "sos_topology": {
                                    "state": "warning",
                                    "snapshot_status": "ok",
                                    "summary": "warning dependencies=3 degraded=1",
                                    "warnings": ["dependency_degraded:power->mobility"],
                                }
                            },
                        }
                    ],
                ...
                "ships": [
                    {
                        ...
                        "services": [
                            {"script_id": "bridge-a-sos_dashboard", "service_id": "dashboard"},
                            {"script_id": "bridge-a-sos_topology", "service_id": "topology"},
                        ],
                    }
                ],
            }
    ...
    scripts = {
        ...
        "bridge-a-sos_dashboard": WorkerScript("bridge-a-sos_dashboard", "manual", "Dashboard", module.__name__, "", "", 1000, True),
        "bridge-a-sos_topology": WorkerScript("bridge-a-sos_topology", "manual", "Topology", module.__name__, "", "", 1000, True),
    }
    ...
    assert result["status"] == "ok"
    dashboard_request = captured[0]
    topology = dashboard_request["runtime_telemetry"]["child_services_by_service_id"]["topology"]["result"]["sos_topology"]
    assert topology["state"] == "warning"
    assert topology["snapshot_status"] == "ok"
    assert topology["warnings"] == ["dependency_degraded:power->mobility"]


def test_execute_sos_orchestrator_runs_topology_child_with_existing_services(tmp_path: Path):
    def install_adapter(module_name: str, summary: str, command: dict[str, object]) -> None:
        module = types.ModuleType(module_name)
    ...
    install_adapter("tests.sos_topology_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_topology_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_topology": WorkerScript(
            "bridge-a-sos_topology",
            "manual",
            "Topology",
            "worker.scripts.sos_topology",
            "",
            "",
            1000,
            True,
        ...
        "bridge-a-inventory": WorkerScript(
            "bridge-a-inventory", "manual", "Inventory", "tests.sos_topology_registry_inventory_child", "", "", 1000, True
        ),
        "bridge-a-doors": WorkerScript("bridge-a-doors", "manual", "Doors", "tests.sos_topology_registry_door_child", "", "", 1000, True),
    }
    ...
    topology_child = result["result"]["child_results"][0]
    assert topology_child["summary"] == (
        "SOS Topology Ship A state=ok dependencies=0 degraded=0 blocked=0 unknown=0 "
        "critical=0 blast=ok warnings=0 blockers=0"
    )
    assert topology_child["result"]["sos_topology"]["snapshot_status"] == "ok"
    assert topology_child["error_bucket"] == "none"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_topology_context_history_and_aliases_to_topology_only(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_topology_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 4,
                        "remaining": 5,
                        "by_source": {"bridge-a-sos_topology": {"queued": 3, "drained": 1, "remaining": 2}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_status",
                        ...
                        },
                        {
                            ...
                            "error_bucket": "none",
                            "summary": "integrity warning",
                            "result": {"sos_integrity": {"state": "warning", "warnings": ["damaged_block:Battery"], "blockers": []}},
                        },
                    ],
                },
            }
    ...
    topology_snapshot = {"dependencies": [{"source": "power", "target": "mobility", "state": "degraded"}]}
    dependency_snapshot = {"chains": [{"source": "power", "target": "mobility", "state": "degraded"}]}
    dependency_map_snapshot = {"dependencies": [{"source_service": "power", "target_service": "mobility", "state": "warning"}]}
    blast_radius_snapshot = {"affected_families": ["mobility"], "state": "warning"}
    ...
    result = execute_request(
        {
            ...
            "grid_snapshot": {
                ...
                "grid_entity_id": 10,
                "blocks": [
                    {"name": "Battery", "type": "BatteryBlock", "integrity_ratio": 0.7, "functional": True},
                ],
            },
            "topology_snapshot": topology_snapshot,
            "dependency_snapshot": dependency_snapshot,
            "dependency_map_snapshot": dependency_map_snapshot,
    ...
    assert result["status"] == "ok"
    topology_request = captured["bridge-a-sos_topology"]
    assert topology_request["sos_ship"]["ship_id"] == "ship-a"
    assert topology_request["topology_snapshot"] == topology_snapshot
    assert topology_request["dependency_snapshot"] == dependency_snapshot
    assert topology_request["dependency_map_snapshot"] == dependency_map_snapshot
    assert topology_request["blast_radius_snapshot"] == blast_radius_snapshot
    assert topology_request["grid_snapshot"]["grid_entity_id"] == 10
    assert topology_request["integrity_snapshot"]["blocks"][0]["name"] == "Battery"
    telemetry = topology_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 9,
        "drained": 4,
    ...
    assert telemetry["child_services_by_service_id"]["status"]["result"]["sos_status"]["identity_status"] == "ok"
    assert telemetry["child_services_by_service_id"]["integrity"]["result"]["sos_integrity"]["state"] == "warning"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_topology"]["command_queue"] == {
        "queued": 3,
        "drained": 1,
        "remaining": 2,
    }
    for sibling in ("bridge-a-sos_status", "bridge-a-sos_integrity"):
        assert "topology_snapshot" not in captured[sibling]
        assert "dependency_snapshot" not in captured[sibling]
        assert "dependency_map_snapshot" not in captured[sibling]
        assert "blast_radius_snapshot" not in captured[sibling]


def test_execute_sos_orchestrator_passes_telemetry_quality_payload_history_to_dashboard_request(tmp_path: Path):
    captured: list[dict] = []
    module = types.ModuleType("tests.sos_dashboard_telemetry_quality_history_child")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_telemetry_quality",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "telemetry quality warning",
                            "result": {
                                "sos_telemetry_quality": {
                                    "state": "warning",
                                    "snapshot_status": "ok",
                                    "summary": "warning confidence=medium evaluated=3 missing=1",
                                    "confidence_label": "medium",
                                    "warnings": ["missing_child_result:power"],
                                }
                            },
                        }
                    ],
                ...
                "ships": [
                    {
                        ...
                        "services": [
                            {"script_id": "bridge-a-sos_dashboard", "service_id": "dashboard"},
                            {"script_id": "bridge-a-sos_telemetry_quality", "service_id": "telemetry_quality"},
                        ],
                    }
                ],
            }
    ...
    scripts = {
        ...
        "bridge-a-sos_dashboard": WorkerScript("bridge-a-sos_dashboard", "manual", "Dashboard", module.__name__, "", "", 1000, True),
        "bridge-a-sos_telemetry_quality": WorkerScript(
            "bridge-a-sos_telemetry_quality", "manual", "Telemetry Quality", module.__name__, "", "", 1000, True
        ),
    }
    ...
    assert result["status"] == "ok"
    dashboard_request = captured[0]
    telemetry_quality = dashboard_request["runtime_telemetry"]["child_services_by_service_id"]["telemetry_quality"]["result"][
        "sos_telemetry_quality"
    ]
    assert telemetry_quality["state"] == "warning"
    assert telemetry_quality["snapshot_status"] == "ok"
    assert telemetry_quality["warnings"] == ["missing_child_result:power"]


def test_execute_sos_orchestrator_runs_telemetry_quality_child_with_existing_services(tmp_path: Path):
    def install_adapter(module_name: str, summary: str, command: dict[str, object]) -> None:
        module = types.ModuleType(module_name)
    ...
    install_adapter("tests.sos_telemetry_quality_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_telemetry_quality_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_telemetry_quality": WorkerScript(
            "bridge-a-sos_telemetry_quality",
            "manual",
            "Telemetry Quality",
            "worker.scripts.sos_telemetry_quality",
            "",
            "",
            1000,
            True,
        ...
        "bridge-a-inventory": WorkerScript(
            "bridge-a-inventory", "manual", "Inventory", "tests.sos_telemetry_quality_registry_inventory_child", "", "", 1000, True
        ),
        "bridge-a-doors": WorkerScript(
            "bridge-a-doors", "manual", "Doors", "tests.sos_telemetry_quality_registry_door_child", "", "", 1000, True
        ),
    }
    ...
    telemetry_quality_child = result["result"]["child_results"][0]
    assert telemetry_quality_child["result"]["sos_telemetry_quality"]["snapshot_status"] in {"ok", "missing_child_result"}
    assert telemetry_quality_child["error_bucket"] == "none"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_telemetry_quality_context_history_and_aliases_to_telemetry_quality_only(
    tmp_path: Path,
):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_telemetry_quality_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 4,
                        "remaining": 5,
                        "by_source": {"bridge-a-sos_telemetry_quality": {"queued": 3, "drained": 1, "remaining": 2}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_status",
                        ...
                        },
                        {
                            ...
                            "error_bucket": "none",
                            "summary": "topology warning",
                            "result": {"sos_topology": {"state": "warning", "warnings": ["dependency_degraded"], "blockers": []}},
                        },
                    ],
                },
            }
    ...
    result = execute_request(
        {
            ...
            "grid_snapshot": {
                "schema": "novali.client_side_pb.grid_snapshot.v1",
                "grid_entity_id": 10,
                "blocks": [{"name": "Battery", "type": "BatteryBlock"}],
            },
            "telemetry_quality_snapshot": telemetry_quality_snapshot,
    ...
    assert result["status"] == "ok"
    telemetry_quality_request = captured["bridge-a-sos_telemetry_quality"]
    assert telemetry_quality_request["sos_ship"]["ship_id"] == "ship-a"
    assert telemetry_quality_request["telemetry_quality_snapshot"] == telemetry_quality_snapshot
    assert telemetry_quality_request["evidence_snapshot"] == evidence_snapshot
    assert telemetry_quality_request["data_quality_snapshot"] == data_quality_snapshot
    assert telemetry_quality_request["signal_quality_snapshot"] == signal_quality_snapshot
    assert telemetry_quality_request["grid_snapshot"]["grid_entity_id"] == 10
    telemetry = telemetry_quality_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 9,
        "drained": 4,
    ...
    assert telemetry["command_queue"] == telemetry["queue_pressure"]
    assert telemetry["child_services_by_service_id"]["status"]["result"]["sos_status"]["identity_status"] == "ok"
    assert telemetry["child_services_by_service_id"]["topology"]["result"]["sos_topology"]["state"] == "warning"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_telemetry_quality"]["command_queue"] == {
        "queued": 3,
        "drained": 1,
        "remaining": 2,
    }
    for sibling in ("bridge-a-sos_status", "bridge-a-sos_topology"):
        assert "telemetry_quality_snapshot" not in captured[sibling]
        assert "evidence_snapshot" not in captured[sibling]
        assert "data_quality_snapshot" not in captured[sibling]
        assert "signal_quality_snapshot" not in captured[sibling]


def test_execute_sos_orchestrator_passes_config_drift_payload_history_to_dashboard_request(tmp_path: Path):
    captured: list[dict] = []
    module = types.ModuleType("tests.sos_dashboard_config_drift_history_child")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_config_drift",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "config drift warning",
                            "result": {
                                "sos_config_drift": {
                                    "state": "warning",
                                    "snapshot_status": "ok",
                                    "summary": "warning snapshots=present expected=3 observed=2 missing=1",
                                    "missing_service_count": 1,
                                    "warnings": ["missing_service:power"],
                                }
                            },
                        }
                    ],
    ...
    scripts = {
        ...
        "bridge-a-sos_dashboard": WorkerScript("bridge-a-sos_dashboard", "manual", "Dashboard", module.__name__, "", "", 1000, True),
        "bridge-a-sos_config_drift": WorkerScript(
            "bridge-a-sos_config_drift", "manual", "Config Drift", module.__name__, "", "", 1000, True
        ),
    }
    ...
    assert result["status"] == "ok"
    dashboard_request = captured[0]
    config_drift = dashboard_request["runtime_telemetry"]["child_services_by_service_id"]["config_drift"]["result"][
        "sos_config_drift"
    ]
    assert config_drift["state"] == "warning"
    assert config_drift["snapshot_status"] == "ok"
    assert config_drift["warnings"] == ["missing_service:power"]


def test_execute_sos_orchestrator_runs_config_drift_child_with_existing_services(tmp_path: Path):
    def install_adapter(module_name: str, summary: str, command: dict[str, object]) -> None:
        module = types.ModuleType(module_name)
    ...
    install_adapter("tests.sos_config_drift_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_config_drift_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_config_drift": WorkerScript(
            "bridge-a-sos_config_drift",
            "manual",
            "Config Drift",
            "worker.scripts.sos_config_drift",
            "",
            "",
            1000,
            True,
        ...
        "bridge-a-inventory": WorkerScript(
            "bridge-a-inventory", "manual", "Inventory", "tests.sos_config_drift_registry_inventory_child", "", "", 1000, True
        ),
        "bridge-a-doors": WorkerScript(
            "bridge-a-doors", "manual", "Doors", "tests.sos_config_drift_registry_door_child", "", "", 1000, True
        ),
    }
    ...
    config_drift_child = result["result"]["child_results"][0]
    assert config_drift_child["summary"].startswith("SOS Config Drift Ship A state=")
    assert config_drift_child["result"]["sos_config_drift"]["snapshot_status"] in {"ok", "partial", "missing_child_result"}
    assert config_drift_child["error_bucket"] == "none"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_config_drift_context_history_and_aliases_to_config_drift_only(
    tmp_path: Path,
):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_config_drift_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 4,
                        "remaining": 5,
                        "by_source": {"bridge-a-sos_config_drift": {"queued": 3, "drained": 1, "remaining": 2}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_status",
                        ...
                        },
                        {
                            ...
                            "error_bucket": "none",
                            "summary": "diagnostics warning",
                            "result": {"sos_diagnostics": {"state": "warning", "warnings": ["missing_child_result"]}},
                        },
                    ],
                },
            }
    ...
    manifest_snapshot = {
        ...
        "scripts": [{"script_id": "sos_config_drift", "module": module.__name__, "enabled": True}],
    }
    script_instances_snapshot = {
        "schema": "novali.client_side_pb.script_instances.v1",
        "instances": {"bridge-a-sos_config_drift": {"base_script_id": "sos_config_drift", "enabled": True}},
    }
    (data / "sos_ships.json").write_text(json.dumps(ship_registry), encoding="utf-8")
    (data / "script_instances.json").write_text(json.dumps(script_instances_snapshot), encoding="utf-8")
    (worker_dir / "manifest.json").write_text(json.dumps(manifest_snapshot), encoding="utf-8")
    scripts = {
        "bridge-a-orchestrator": WorkerScript(
            "bridge-a-orchestrator", "script_instance", "Bridge A SOS", "", "", "", 1000, True, base_script_id="bridge_orchestrator"
        ),
    ...
    configuration_snapshot = {"services": [{"service_id": "diagnostics", "script_id": "bridge-a-sos_diagnostics"}]}
    registry_snapshot = {"services": [{"service_id": "config_drift", "script_id": "bridge-a-sos_config_drift"}]}
    ...
    result = execute_request(
        {
            ...
            "config_drift_snapshot": config_drift_snapshot,
    ...
    assert result["status"] == "ok"
    config_drift_request = captured["bridge-a-sos_config_drift"]
    assert config_drift_request["sos_ship"]["ship_id"] == "ship-a"
    assert config_drift_request["config_drift_snapshot"] == config_drift_snapshot
    assert config_drift_request["configuration_snapshot"] == configuration_snapshot
    assert config_drift_request["registry_snapshot"] == registry_snapshot
    assert config_drift_request["ship_registry_snapshot"] == ship_registry
    assert config_drift_request["template_snapshot"] == template_snapshot
    assert config_drift_request["host_manifest_snapshot"] == manifest_snapshot
    assert config_drift_request["script_instances_snapshot"] == script_instances_snapshot
    assert config_drift_request["grid_snapshot"]["grid_entity_id"] == 10
    telemetry = config_drift_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 9,
        "drained": 4,
    ...
    assert telemetry["command_queue"] == telemetry["queue_pressure"]
    assert telemetry["child_services_by_service_id"]["status"]["result"]["sos_status"]["identity_status"] == "ok"
    assert telemetry["child_services_by_service_id"]["diagnostics"]["result"]["sos_diagnostics"]["state"] == "warning"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_config_drift"]["command_queue"] == {
        "queued": 3,
        "drained": 1,
        "remaining": 2,
    }
    for sibling in ("bridge-a-sos_status", "bridge-a-sos_diagnostics"):
        assert "config_drift_snapshot" not in captured[sibling]
        assert "configuration_snapshot" not in captured[sibling]
        assert "registry_snapshot" not in captured[sibling]
        assert "ship_registry_snapshot" not in captured[sibling]
        assert "template_snapshot" not in captured[sibling]
        assert "host_manifest_snapshot" not in captured[sibling]
        assert "script_instances_snapshot" not in captured[sibling]


def test_execute_sos_orchestrator_passes_automation_payload_history_to_dashboard_request(tmp_path: Path):
    captured: list[dict] = []
    module = types.ModuleType("tests.sos_dashboard_automation_history_child")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_automation",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "automation warning",
                            "result": {
                                "sos_automation": {
                                    "state": "warning",
                                    "snapshot_status": "ok",
                                    "summary": "warning pbs=2/3 failing=1",
                                    "loop_state": "degraded",
                                    "warnings": ["pb_failing:Main PB"],
                                }
                            },
                        }
                    ],
                ...
                "ships": [
                    {
                        ...
                        "services": [
                            {"script_id": "bridge-a-sos_dashboard", "service_id": "dashboard"},
                            {"script_id": "bridge-a-sos_automation", "service_id": "automation"},
                        ],
                    }
                ],
            }
    ...
    scripts = {
        ...
        "bridge-a-sos_dashboard": WorkerScript("bridge-a-sos_dashboard", "manual", "Dashboard", module.__name__, "", "", 1000, True),
        "bridge-a-sos_automation": WorkerScript("bridge-a-sos_automation", "manual", "Automation", module.__name__, "", "", 1000, True),
    }
    ...
    assert result["status"] == "ok"
    dashboard_request = captured[0]
    automation = dashboard_request["runtime_telemetry"]["child_services_by_service_id"]["automation"]["result"]["sos_automation"]
...
def test_execute_sos_orchestrator_runs_automation_child_with_existing_services(tmp_path: Path):
    ...
    install_adapter("tests.sos_automation_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_automation_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_automation": WorkerScript(
            "bridge-a-sos_automation",
            "manual",
            "Automation",
            "worker.scripts.sos_automation",
            "",
            "",
            1000,
            True,
        ...
        "bridge-a-inventory": WorkerScript(
            "bridge-a-inventory", "manual", "Inventory", "tests.sos_automation_registry_inventory_child", "", "", 1000, True
        ),
        "bridge-a-doors": WorkerScript("bridge-a-doors", "manual", "Doors", "tests.sos_automation_registry_door_child", "", "", 1000, True),
    }
    ...
    result = execute_request(
        {
            ...
            "grid_snapshot": {
                "schema": "novali.client_side_pb.grid_snapshot.v1",
                "grid_entity_id": 0,
                "blocks": [{"name": "Main PB", "type": "ProgrammableBlock", "integrity_ratio": 1.0, "functional": True}],
            },
            "state": {},
        },
        scripts,
    ...
    automation_child = result["result"]["child_results"][0]
    assert automation_child["summary"].startswith("SOS Automation Ship A state=")
    assert automation_child["result"]["sos_automation"]["snapshot_status"] in {"ok", "no_snapshot"}
    assert automation_child["error_bucket"] == "none"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_automation_context_history_and_aliases_to_automation_only(
    tmp_path: Path,
):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_automation_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 4,
                        "remaining": 5,
                        "by_source": {"bridge-a-sos_automation": {"queued": 3, "drained": 1, "remaining": 2}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_status",
                        ...
                        },
                        {
                            ...
                            "error_bucket": "none",
                            "summary": "integrity warning",
                            "result": {"sos_integrity": {"state": "warning", "warnings": ["damaged_block:Main PB"]}},
                        },
                    ],
                },
            }
    ...
    automation_snapshot = {"programmable_blocks": [{"name": "Main PB", "enabled": True, "running": True}]}
    ...
    result = execute_request(
        {
            ...
            "grid_snapshot": {
                "schema": "novali.client_side_pb.grid_snapshot.v1",
                "grid_entity_id": 10,
                "blocks": [{"name": "Main PB", "type": "ProgrammableBlock", "integrity_ratio": 0.9, "functional": True}],
            },
            "automation_snapshot": automation_snapshot,
            "control_logic_snapshot": control_logic_snapshot,
            "script_health_snapshot": script_health_snapshot,
            "pb_snapshot": pb_snapshot,
            "programmable_block_snapshot": programmable_block_snapshot,
            "state": {},
        },
        scripts,
        {},
    ...
    assert result["status"] == "ok"
    automation_request = captured["bridge-a-sos_automation"]
    assert automation_request["sos_ship"]["ship_id"] == "ship-a"
    assert automation_request["automation_snapshot"] == automation_snapshot
    assert automation_request["control_logic_snapshot"] == control_logic_snapshot
    assert automation_request["script_health_snapshot"] == script_health_snapshot
    assert automation_request["pb_snapshot"] == pb_snapshot
    assert automation_request["programmable_block_snapshot"] == programmable_block_snapshot
    assert automation_request["grid_snapshot"]["grid_entity_id"] == 10
    assert automation_request["integrity_snapshot"]["blocks"][0]["name"] == "Main PB"
    telemetry = automation_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 9,
        "drained": 4,
    ...
    assert telemetry["child_services_by_service_id"]["status"]["result"]["sos_status"]["identity_status"] == "ok"
    assert telemetry["child_services_by_service_id"]["integrity"]["result"]["sos_integrity"]["state"] == "warning"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_automation"]["command_queue"] == {
        "queued": 3,
        "drained": 1,
        "remaining": 2,
    }
    for sibling in ("bridge-a-sos_status", "bridge-a-sos_integrity"):
        assert "automation_snapshot" not in captured[sibling]
        assert "control_logic_snapshot" not in captured[sibling]
        assert "script_health_snapshot" not in captured[sibling]
        assert "pb_snapshot" not in captured[sibling]
        assert "programmable_block_snapshot" not in captured[sibling]


def test_execute_sos_orchestrator_scopes_automation_plan_evidence_and_preserves_empty_commands(
    tmp_path: Path,
):
    from worker.scripts.sos_automation_plan import run as run_automation_plan

    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_automation_plan_capture_children")

    def run(request):
        captured[request["script_id"]] = request
        if request["script_id"] == "bridge-a-sos_automation_plan":
            return run_automation_plan(request)
        return {"summary": f"{request['script_id']} captured", "commands": []}
                    ...
                    "child_results": [
                        {
                            ...
                            "error_bucket": "none",
                            "summary": "automation warning",
                            "result": {"sos_automation": {"state": "warning", "warnings": ["pb_failing:Main PB"]}},
                        },
                        {
                            "script_id": "bridge-a-sos_diagnostics",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "diagnostics warning",
                            "result": {"sos_diagnostics": {"state": "warning", "warnings": ["child_error:automation"]}},
                        },
                    ],
                }
            }
                ...
                "ships": [
                    {
                        ...
                        "expected_grid_entity_id": 10,
                        "services": [
                            {"script_id": "bridge-a-sos_automation_plan", "service_id": "automation_plan"},
                            {"script_id": "bridge-a-sos_automation", "service_id": "automation"},
                            {"script_id": "bridge-a-sos_status", "service_id": "status"},
                            {"script_id": "bridge-a-sos_diagnostics", "service_id": "diagnostics"},
                        ],
    ...
    scripts = {
        ...
        "bridge-a-sos_automation_plan": WorkerScript(
            "bridge-a-sos_automation_plan", "manual", "Automation Plan", module.__name__, "", "", 1000, True
        ),
        "bridge-a-sos_automation": WorkerScript("bridge-a-sos_automation", "manual", "Automation", module.__name__, "", "", 1000, True),
        "bridge-a-sos_status": WorkerScript("bridge-a-sos_status", "manual", "Status", module.__name__, "", "", 1000, True),
        "bridge-a-sos_diagnostics": WorkerScript(
            "bridge-a-sos_diagnostics", "manual", "Diagnostics", module.__name__, "", "", 1000, True
        ),
    }
    plan_snapshot = {
        "plans": [
    ...
    result = execute_request(
        {
            ...
            "grid_snapshot": {
                "schema": "novali.client_side_pb.grid_snapshot.v1",
                "grid_entity_id": 10,
                "blocks": [{"name": "Main PB", "type": "ProgrammableBlock", "integrity_ratio": 0.9, "functional": False}],
            },
            "automation_plan_snapshot": plan_snapshot,
    ...
    assert result["status"] == "ok"
    plan_request = captured["bridge-a-sos_automation_plan"]
    assert plan_request["sos_ship"]["ship_id"] == "ship-a"
    assert plan_request["grid_snapshot"]["grid_entity_id"] == 10
    assert plan_request["integrity_snapshot"]["blocks"][0]["name"] == "Main PB"
    assert plan_request["automation_plan_snapshot"] == plan_snapshot
    assert plan_request["runtime_telemetry"]["queue_pressure"] == {"queued": 2, "drained": 1, "remaining": 1, "by_source": {}}
    assert plan_request["runtime_telemetry"]["child_services_by_service_id"]["automation"]["result"]["sos_automation"]["state"] == "warning"
    assert plan_request["runtime_telemetry"]["child_services_by_service_id"]["diagnostics"]["result"]["sos_diagnostics"]["state"] == "warning"
    assert "automation_snapshot" not in plan_request
    for sibling in ("bridge-a-sos_automation", "bridge-a-sos_status", "bridge-a-sos_diagnostics"):
        for alias in (
            ...
            assert alias not in captured[sibling]
    plan_child = result["result"]["child_results"][0]
    assert any(
        plan["action_family"] == "programmable_block_recovery"
...
def test_execute_sos_orchestrator_scopes_automation_recovery_approval_and_preserves_receipt(tmp_path: Path):
    from worker.scripts.sos_automation_recovery import run as run_automation_recovery

    captured: dict[str, dict] = {}
    recovery_module = types.ModuleType("tests.sos_automation_recovery_capture")
    sibling_module = types.ModuleType("tests.sos_automation_recovery_siblings")

    def run_recovery(request):
        captured["recovery"] = request
        captured["recovery_output"] = run_automation_recovery(request)
        return captured["recovery_output"]

    def run_sibling(request):
        captured[request["script_id"]] = request
        return {"summary": request["script_id"], "commands": []}

    recovery_module.run = run_recovery
    sibling_module.run = run_sibling
    sys.modules[recovery_module.__name__] = recovery_module
                ...
                "ships": [
                    {
                        ...
                        "services": [
                            {"script_id": "bridge-a-sos_automation_plan", "service_id": "automation_plan"},
                            {"script_id": "bridge-a-sos_automation_recovery", "service_id": "automation_recovery"},
                            {"script_id": "bridge-a-sos_status", "service_id": "status"},
                        ],
                        "status_surfaces": [],
                    }
    ...
    scripts = {
        ...
        "bridge-a-sos_automation_plan": WorkerScript(
            "bridge-a-sos_automation_plan", "manual", "Automation Plan", sibling_module.__name__, "", "", 1000, True
        ),
        "bridge-a-sos_automation_recovery": WorkerScript(
            "bridge-a-sos_automation_recovery", "manual", "Automation Recovery", recovery_module.__name__, "", "", 1000, True
        ),
    ...
    assert recovery_request["grid_snapshot"]["grid_entity_id"] == 10
    assert recovery_request["integrity_snapshot"]["blocks"][0]["name"] == "Recovery PB"
    assert recovery_request["runtime_telemetry"]["child_services_by_service_id"]["automation_plan"]["result"]["sos_automation_plan"]["plans"] == [plan]
    assert recovery_request["operator_approval_snapshot"]["action_id"] == "sos-action-1"
    assert captured["recovery_output"]["sos_automation_recovery"]["reason"] == "approved_recovery_emitted"
    assert captured["recovery_output"]["commands"] == [
        {
    ...
    for sibling in ("bridge-a-sos_automation_plan", "bridge-a-sos_status"):
        for alias in ("operator_approval_snapshot", "automation_approval_snapshot", "sos_automation_approval"):
            assert alias not in captured[sibling]

    queued_command = result["result"]["commands"][0]
    assert {
        key: queued_command[key]
        for key in (
            "kind",
            "block_entity_id",
            "enabled",
    ...
    } == captured["recovery_output"]["commands"][0]
    assert queued_command["source_script_id"] == "bridge-a-sos_automation_recovery"
...
def test_execute_sos_orchestrator_runs_redundancy_child_with_existing_services(tmp_path: Path):
    ...
    install_adapter("tests.sos_redundancy_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_redundancy_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_redundancy": WorkerScript(
            "bridge-a-sos_redundancy",
            "manual",
            "Redundancy",
            "worker.scripts.sos_redundancy",
            "",
            "",
            1000,
            True,
        ...
        "bridge-a-inventory": WorkerScript(
            "bridge-a-inventory", "manual", "Inventory", "tests.sos_redundancy_registry_inventory_child", "", "", 1000, True
        ),
        "bridge-a-doors": WorkerScript("bridge-a-doors", "manual", "Doors", "tests.sos_redundancy_registry_door_child", "", "", 1000, True),
    }
    ...
    redundancy_child = result["result"]["child_results"][0]
    assert redundancy_child["summary"] == "SOS Redundancy Ship A state=unknown snapshot=missing_child_result"
    assert redundancy_child["result"]["sos_redundancy"]["snapshot_status"] == "missing_child_result"
    assert redundancy_child["error_bucket"] == "none"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_redundancy_context_history_and_aliases_to_redundancy_only(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_redundancy_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 5,
                        "remaining": 6,
                        "by_source": {"bridge-a-sos_redundancy": {"queued": 4, "drained": 1, "remaining": 3}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_power",
                        ...
                        },
                        {
                            ...
                            "error_bucket": "none",
                            "summary": "mobility ok",
                            "result": {"sos_mobility": {"state": "ok", "warnings": [], "blockers": []}},
                        },
                        {
                            "script_id": "bridge-a-sos_display",
                            "status": "ok",
                            "error_bucket": "none",
                            "summary": "display ok",
                            "result": {"sos_display": {"state": "ok", "warnings": [], "blockers": []}},
                        },
                    ],
                },
            }
    ...
    failover_snapshot = {"capabilities": {"comms": {"primary_count": 1, "backup_count": 0}}}
    critical_systems_snapshot = {"systems": [{"name": "Battery", "type": "power", "present": True}]}
    coverage_snapshot = {"capabilities": {"display": {"primary_count": 1, "backup_count": 1}}}
    resilience_snapshot = {"capabilities": {"life_support": {"primary_count": 1, "backup_count": 1}}}
    display_snapshot = {"available_surfaces": 2, "surface_count": 2}
    ...
    result = execute_request(
        {
            ...
            "redundancy_snapshot": redundancy_snapshot,
            "failover_snapshot": failover_snapshot,
            "critical_systems_snapshot": critical_systems_snapshot,
            "coverage_snapshot": coverage_snapshot,
            "resilience_snapshot": resilience_snapshot,
            "power_snapshot": {"state": "warning"},
            "mobility_snapshot": {"state": "ok"},
            "comms_snapshot": {"state": "ok"},
            "life_support_snapshot": {"state": "ok"},
            "docking_snapshot": {"state": "ok"},
            "transit_snapshot": {"state": "ok"},
            "defense_snapshot": {"state": "ok"},
            "display_snapshot": display_snapshot,
            "state": {},
        },
        scripts,
    ...
    assert result["status"] == "ok"
    redundancy_request = captured["bridge-a-sos_redundancy"]
    assert redundancy_request["sos_ship"]["ship_id"] == "ship-a"
    assert redundancy_request["redundancy_snapshot"] == redundancy_snapshot
    assert redundancy_request["failover_snapshot"] == failover_snapshot
    assert redundancy_request["critical_systems_snapshot"] == critical_systems_snapshot
    assert redundancy_request["coverage_snapshot"] == coverage_snapshot
    assert redundancy_request["resilience_snapshot"] == resilience_snapshot
    assert redundancy_request["grid_snapshot"]["grid_entity_id"] == 10
    assert redundancy_request["integrity_snapshot"]["blocks"][0]["name"] == "Battery"
    assert redundancy_request["inventory_snapshot"]["cargo"] == {"used_volume": 12.0, "max_volume": 100.0}
    assert redundancy_request["power_snapshot"] == {"state": "warning"}
    assert redundancy_request["mobility_snapshot"] == {"state": "ok"}
    assert redundancy_request["comms_snapshot"] == {"state": "ok"}
    assert redundancy_request["life_support_snapshot"] == {"state": "ok"}
    assert redundancy_request["docking_snapshot"] == {"state": "ok"}
    assert redundancy_request["transit_snapshot"] == {"state": "ok"}
    assert redundancy_request["defense_snapshot"] == {"state": "ok"}
    assert redundancy_request["display_snapshot"] == display_snapshot
    telemetry = redundancy_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 11,
        "drained": 5,
    ...
    assert telemetry["command_queue"] == telemetry["queue_pressure"]
    assert telemetry["child_services_by_service_id"]["power"]["result"]["sos_power"]["state"] == "warning"
    assert telemetry["child_services_by_service_id"]["mobility"]["result"]["sos_mobility"]["state"] == "ok"
    assert telemetry["child_services_by_service_id"]["display"]["result"]["sos_display"]["state"] == "ok"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_redundancy"]["command_queue"] == {
        "queued": 4,
        "drained": 1,
        "remaining": 3,
    }
    for sibling in ("bridge-a-sos_status", "bridge-a-sos_power", "bridge-a-sos_mobility", "bridge-a-sos_display", "bridge-a-inventory"):
        assert "redundancy_snapshot" not in captured[sibling]
        assert "failover_snapshot" not in captured[sibling]
        assert "critical_systems_snapshot" not in captured[sibling]
        assert "coverage_snapshot" not in captured[sibling]
        assert "resilience_snapshot" not in captured[sibling]
    assert "display_snapshot" not in captured["bridge-a-sos_status"]
    assert captured["bridge-a-sos_display"]["display_snapshot"] == display_snapshot


def test_execute_sos_orchestrator_runs_runbook_child_with_existing_services(tmp_path: Path):
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_runbook": WorkerScript(
            "bridge-a-sos_runbook",
            "manual",
            "Runbook",
            "worker.scripts.sos_runbook",
            "",
            "",
            1000,
            True,
    ...
    runbook_child = result["result"]["child_results"][0]
    assert runbook_child["summary"] == "SOS Runbook Ship A state=unknown procedure=Docked Watch source=mode blocked=0 attention=0 unknown=6"
    assert runbook_child["result"]["sos_runbook"]["snapshot_status"] == "missing_child_result"
    assert runbook_child["error_bucket"] == "none"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_runbook_context_history_and_aliases_to_runbook_only(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_runbook_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "queue_pressure": {
                        ...
                        "drained": 3,
                        "remaining": 5,
                        "by_source": {"bridge-a-sos_runbook": {"queued": 2, "drained": 1, "remaining": 1}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_docking",
                            ...
                            "error_bucket": "none",
                            "summary": "docking ok",
                            "result": {"sos_docking": {"state": "ok", "warnings": [], "blockers": []}},
                        },
                        {
                            "script_id": "bridge-a-sos_power",
                            "status": "ok",
                        ...
                        },
                        {
                            ...
                            "result": {"sos_diagnostics": {"state": "ok", "warnings": [], "blockers": []}},
                        },
                    ],
                },
            }
    ...
    runbook_snapshot = {"procedure": "Docked Watch"}
    checklist_snapshot = {"checklist": "Docked Watch"}
    procedure_snapshot = {"active_procedure": "Docked Watch"}
    ...
    result = execute_request(
        {
            ...
            "script_id": "bridge-a-orchestrator",
            "runtime_telemetry": {"limiter_state": "ok"},
            "runbook_snapshot": runbook_snapshot,
    ...
    assert result["status"] == "ok"
    runbook_request = captured["bridge-a-sos_runbook"]
    assert runbook_request["sos_ship"]["ship_id"] == "ship-a"
    assert runbook_request["runbook_snapshot"] == runbook_snapshot
    assert runbook_request["checklist_snapshot"] == checklist_snapshot
    assert runbook_request["procedure_snapshot"] == procedure_snapshot
    telemetry = runbook_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 8,
        "drained": 3,
    ...
    assert telemetry["command_queue"] == telemetry["queue_pressure"]
    assert telemetry["child_services_by_service_id"]["power"]["result"]["sos_power"]["state"] == "warning"
    assert telemetry["child_services_by_service_id"]["diagnostics"]["result"]["sos_diagnostics"]["state"] == "ok"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_runbook"]["command_queue"] == {
        "queued": 2,
        "drained": 1,
        "remaining": 1,
    }
    for sibling in ("bridge-a-sos_power", "bridge-a-sos_diagnostics", "bridge-a-inventory"):
        assert "runbook_snapshot" not in captured[sibling]
        assert "checklist_snapshot" not in captured[sibling]
        assert "procedure_snapshot" not in captured[sibling]


def test_execute_sos_orchestrator_passes_readiness_context_history_and_queue_to_readiness_only(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_readiness_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "command_queue": {
                        ...
                        "drained": 2,
                        "remaining": 7,
                        "by_source": {"bridge-a-sos_readiness": {"queued": 3, "drained": 1, "remaining": 2}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_status",
    ...
    readiness_snapshot = {"operator_verdict": "review"}
    ...
    result = execute_request(
        {
            ...
            "operator_readiness_snapshot": {"operator": "bridge"},
            "state": {},
        },
        scripts,
        {},
    ...
    assert result["status"] == "ok"
    readiness_request = captured["bridge-a-sos_readiness"]
    assert readiness_request["sos_ship"]["ship_id"] == "ship-a"
    assert readiness_request["readiness_snapshot"] == readiness_snapshot
    assert readiness_request["operator_readiness_snapshot"] == {"operator": "bridge"}
    telemetry = readiness_request["runtime_telemetry"]
    assert any(item["service_id"] == "readiness" for item in telemetry["child_services"])
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 9,
        "drained": 2,
    ...
    assert telemetry["child_services_by_service_id"]["status"]["result"]["sos_status"]["mode"] == "Combat"
    assert telemetry["child_services_by_service_id"]["power"]["result"]["sos_power"]["state"] == "warning"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_readiness"]["command_queue"] == {
        "queued": 3,
        "drained": 1,
        "remaining": 2,
    }
    for sibling in ("bridge-a-sos_status", "bridge-a-sos_power", "bridge-a-inventory"):
        assert "readiness_snapshot" not in captured[sibling]
        assert "operator_readiness_snapshot" not in captured[sibling]


def test_execute_sos_readiness_child_degrades_gracefully_without_child_history(tmp_path: Path):
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
                ...
                "ships": [
                    {
                        ...
                        "display_name": "Ship A",
                        "expected_grid_entity_id": 10,
                        "services": [{"script_id": "bridge-a-sos_readiness", "service_id": "readiness"}],
                    }
                ],
            }
        ),
    ...
    assert result["status"] == "ok"
    readiness_child = result["result"]["child_results"][0]
    assert readiness_child["summary"] == "SOS Readiness Ship A state=degraded score=0/12 action=review_warnings"
    assert readiness_child["result"]["sos_readiness"]["snapshot_status"] == "ok"
    assert readiness_child["result"]["sos_readiness"]["unknown_sources"] == [
        "logistics",
        "production",
        "maintenance",
        "power",
...
def test_execute_sos_orchestrator_runs_guidance_child_with_existing_services(tmp_path: Path):
    def install_adapter(module_name: str, summary: str, command: dict[str, object]) -> None:
        module = types.ModuleType(module_name)
    ...
    install_adapter("tests.sos_guidance_registry_status_child", "status ok", {"kind": "echo", "text": "status"})
    install_adapter("tests.sos_guidance_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_guidance_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_status": WorkerScript("bridge-a-sos_status", "manual", "Status", "tests.sos_guidance_registry_status_child", "", "", 1000, True),
        "bridge-a-sos_guidance": WorkerScript(
            "bridge-a-sos_guidance",
            "manual",
            "Guidance",
            "worker.scripts.sos_guidance",
            "",
            "",
            1000,
            True,
        ),
        "bridge-a-inventory": WorkerScript("bridge-a-inventory", "manual", "Inventory", "tests.sos_guidance_registry_inventory_child", "", "", 1000, True),
        "bridge-a-doors": WorkerScript("bridge-a-doors", "manual", "Doors", "tests.sos_guidance_registry_door_child", "", "", 1000, True),
    }
    ...
    guidance_child = result["result"]["child_results"][1]
    assert guidance_child["summary"] == "SOS Guidance Ship A state=unknown priorities=0 snapshot=missing_child_result"
    assert guidance_child["result"]["sos_guidance"]["snapshot_status"] == "missing_child_result"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_guidance_runtime_telemetry_to_guidance_only(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_guidance_capture_children")
        ...
        json.dumps(
            {
                ...
                "result": {
                    "command_queue": {
                        ...
                        "drained": 1,
                        "remaining": 4,
                        "by_source": {"bridge-a-sos_guidance": {"queued": 2, "drained": 0, "remaining": 2}},
                    },
                    "child_results": [
                        {
                            "script_id": "bridge-a-sos_readiness",
                            ...
                            "result": {
                                "sos_readiness": {
                                    "state": "blocked",
                                    "snapshot_status": "ok",
                                    "blockers": ["power:reactor_offline"],
                                    "warnings": ["display:operator_route_missing"],
                                }
                            },
                        },
                        {
                            ...
                            "result": {
                                "sos_alerts": {
                                    "state": "critical",
                                    "snapshot_status": "ok",
                                    "blockers": ["power:critical:reactor_offline"],
                                    "warnings": [],
                                }
                            },
                        },
    ...
    guidance_snapshot = {"operator_hint": "review_power"}
    ...
    result = execute_request(
        {
            ...
            "operator_guidance_snapshot": {"operator": "bridge"},
            "state": {},
        },
        scripts,
        {},
    ...
    assert result["status"] == "ok"
    guidance_request = captured["bridge-a-sos_guidance"]
    assert guidance_request["sos_ship"]["ship_id"] == "ship-a"
    assert guidance_request["guidance_snapshot"] == guidance_snapshot
    assert guidance_request["operator_guidance_snapshot"] == {"operator": "bridge"}
    telemetry = guidance_request["runtime_telemetry"]
    assert telemetry["limiter_state"] == "ok"
    assert telemetry["queue_pressure"] == {
        "queued": 5,
        "drained": 1,
    ...
    assert telemetry["command_queue"] == telemetry["queue_pressure"]
    assert telemetry["child_services_by_service_id"]["readiness"]["result"]["sos_readiness"]["state"] == "blocked"
    assert telemetry["child_services_by_service_id"]["alerts"]["result"]["sos_alerts"]["state"] == "critical"
    assert telemetry["child_services_by_script_id"]["bridge-a-sos_guidance"]["command_queue"] == {
        "queued": 2,
        "drained": 0,
        "remaining": 2,
    }
    for sibling in ("bridge-a-sos_readiness", "bridge-a-sos_alerts", "bridge-a-inventory"):
        assert "guidance_snapshot" not in captured[sibling]
        assert "operator_guidance_snapshot" not in captured[sibling]
...
def test_execute_sos_orchestrator_runs_mining_child_with_existing_services(tmp_path: Path):
    def install_adapter(module_name: str, summary: str, command: dict[str, object]) -> None:
        module = types.ModuleType(module_name)
    ...
    install_adapter("tests.sos_mining_registry_status_child", "status ok", {"kind": "echo", "text": "status"})
    install_adapter("tests.sos_mining_registry_inventory_child", "inventory ok", {"kind": "echo", "text": "inventory"})
    install_adapter("tests.sos_mining_registry_door_child", "doors ok", {"kind": "echo", "text": "doors"})
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
    ...
    scripts = {
        ...
        "bridge-a-sos_status": WorkerScript("bridge-a-sos_status", "manual", "Status", "tests.sos_mining_registry_status_child", "", "", 1000, True),
        "bridge-a-sos_mining": WorkerScript(
            "bridge-a-sos_mining",
            "manual",
            "Mining",
            "worker.scripts.sos_mining",
            "",
            "",
            1000,
            True,
        ),
        "bridge-a-inventory": WorkerScript("bridge-a-inventory", "manual", "Inventory", "tests.sos_mining_registry_inventory_child", "", "", 1000, True),
        "bridge-a-doors": WorkerScript("bridge-a-doors", "manual", "Doors", "tests.sos_mining_registry_door_child", "", "", 1000, True),
    }
    ...
    mining_child = result["result"]["child_results"][1]
    assert mining_child["summary"] == (
        "SOS Mining Ship A state=ok drills=1/1 detectors=1/1 cargo=unknown ore=unknown blockers=0 snapshot=partial"
    )
    assert mining_child["error_bucket"] == "none"
    assert mining_child["result"]["sos_mining"]["snapshot_status"] == "partial"
    assert {command["kind"] for command in result["result"]["commands"]} <= {"echo", "write_text_surface"}


def test_execute_sos_orchestrator_passes_scoped_mining_data_to_mining_child_only(tmp_path: Path):
    captured: dict[str, dict] = {}
    module = types.ModuleType("tests.sos_mining_capture_children")
    ...
    grid_snapshot = {
        ...
        "grid_entity_id": 10,
        "blocks": [
            {"name": "Drill", "type": "ShipDrill", "integrity_ratio": 0.8, "functional": True},
            {"name": "Ore Detector", "type": "OreDetector", "integrity_ratio": 0.95, "functional": True},
            {"name": "LCD", "type": "TextPanel"},
        ],
    }
    mining_snapshot = {"drills": [{"name": "Drill", "functional": True, "enabled": True}]}
    logistics_snapshot = {"cargo": {"used_volume": 90.0, "max_volume": 100.0}, "ore": {"ores": {"Iron": 1200}}}
    power_snapshot = {"state": "ok"}
    production_snapshot = {"state": "warning", "queue": {"blocked_count": 1}}
    environment_snapshot = {"state": "warning", "hazards": [{"name": "storm"}]}
    docking_snapshot = {"state": "ok"}
    ...
    result = execute_request(
        {
            ...
            "grid_snapshot": grid_snapshot,
            "mining_snapshot": mining_snapshot,
            "harvest_snapshot": {"collectors": [{"name": "Collector", "functional": True}]},
            "resource_snapshot": {"ore": {"ore_types": ["Iron"]}},
            "ore_snapshot": {"ore_types": ["Iron"]},
            "logistics_snapshot": logistics_snapshot,
            "power_snapshot": power_snapshot,
            "production_snapshot": production_snapshot,
            "environment_snapshot": environment_snapshot,
            "docking_snapshot": docking_snapshot,
            "state": {},
        },
        scripts,
        {},
    ...
    assert result["status"] == "ok"
    assert captured["bridge-a-sos_mining"]["grid_snapshot"] == grid_snapshot
    assert captured["bridge-a-sos_mining"]["mining_snapshot"] == mining_snapshot
    assert captured["bridge-a-sos_mining"]["inventory_snapshot"] == logistics_snapshot
    assert captured["bridge-a-sos_mining"]["logistics_snapshot"] == logistics_snapshot
    assert captured["bridge-a-sos_mining"]["power_snapshot"] == power_snapshot
    assert captured["bridge-a-sos_mining"]["production_snapshot"] == production_snapshot
    assert captured["bridge-a-sos_mining"]["environment_snapshot"] == environment_snapshot
    assert captured["bridge-a-sos_mining"]["docking_snapshot"] == docking_snapshot
    assert captured["bridge-a-sos_mining"]["integrity_snapshot"] == {
        "blocks": [
            {"name": "Drill", "type": "ShipDrill", "integrity_ratio": 0.8, "functional": True},
            {"name": "Ore Detector", "type": "OreDetector", "integrity_ratio": 0.95, "functional": True},
        ],
    ...
    for key in ("mining_snapshot", "harvest_snapshot", "resource_snapshot", "ore_snapshot", "environment_snapshot"):
        assert key not in captured["bridge-a-inventory"]
    assert "integrity_snapshot" not in captured["bridge-a-inventory"]


def test_execute_sos_mining_child_degrades_gracefully_without_snapshot(tmp_path: Path):
    data = tmp_path / "data"
    data.mkdir()
    (data / "sos_ships.json").write_text(
        json.dumps(
                ...
                "ships": [
                    {
                        ...
                        "bridge_id": "bridge-a",
                        "display_name": "Ship A",
                        "services": [{"script_id": "bridge-a-sos_mining", "service_id": "mining"}],
                    }
                ],
            }
        ),
    ...
    assert result["status"] == "ok"
    mining_child = result["result"]["child_results"][0]
    assert mining_child["summary"] == "SOS Mining Ship A state=unknown snapshot=no_snapshot"
    assert mining_child["result"]["sos_mining"]["snapshot_status"] == "no_snapshot"
    assert result["result"]["commands"] == [
        {
            "kind": "echo",
            "text": "SOS Mining Ship A state=unknown snapshot=no_snapshot",
            "source_script_id": "bridge-a-sos_mining",
            "source_priority": 17,
            "source_order": 0,
            "source_role": "status",
        }
...
def test_compact_result_for_storage_bounds_verbose_sos_child_payloads():
    payload = {
        "schema": "novali.client_side_pb_bridge.v1",
        "message_kind": "result",
        "bridge_id": "bridge-large",
        "sequence": 42,
        "script_id": "bridge-large-orchestrator",
        "status": "ok",
        "error_bucket": "none",
        "completed_at": "2026-08-29T20:00:00Z",
        "result": {
            "summary": "bridge_orchestrator processed 24 child script(s)",
            "commands": [
                {"kind": "echo", "text": "status " + ("x" * 5000), "source_script_id": "bridge-large-sos_status"},
                {"kind": "write_text_surface", "text": "dashboard", "source_script_id": "bridge-large-sos_display"},
                *(
                    {"kind": "echo", "text": f"service-{index}", "source_script_id": f"bridge-large-sos_service_{index}"}
                    for index in range(20)
                ),
            ],
            "command_queue": {"state": "active", "queued": 0, "drained": 2, "remaining": 0},
            "child_results": [
                {
                    "script_id": "bridge-large-sos_docking",
                    "status": "ok",
                    "error_bucket": "none",
                    "summary": "SOS Docking Large Ship state=warning connectors=0/160",
                    "result": {
                        "sos_docking": {
                            "state": "warning",
                            "warnings": [f"connector_unlocked_while_docked:{index}" for index in range(300)],
                            "details": {"notes": "y" * 10000},
                        }
                    },
                    "command_queue": {"queued": 0, "drained": 1, "remaining": 0},
                }
            ],
        },
    }

    compacted = compact_result_for_storage(payload)

    assert compacted["sequence"] == 42
    assert compacted["status"] == "ok"
    assert compacted["result"]["summary"] == "bridge_orchestrator processed 24 child script(s)"
    assert compacted["result"]["storage_compacted"] is True
    assert compacted["result"]["commands"][0]["source_script_id"] == "bridge-large-sos_status"
    assert len(compacted["result"]["commands"][0]["text"]) < 240
    assert compacted["result"]["commands"][-1] == {"truncated_count": 6}
    child = compacted["result"]["child_results"][0]
    assert child["script_id"] == "bridge-large-sos_docking"
    assert child["summary"] == "SOS Docking Large Ship state=warning connectors=0/160"
    assert len(child["result"]["sos_docking"]["warnings"]) < 60
    assert child["result"]["sos_docking"]["warnings"][-1]["truncated_count"] == 272
    assert len(json.dumps(compacted)) < 12000
